...
*/
	...
	define("CANDIDACY_MAX",20);						//検索候補出力制限最大値
	define("CANDIDACY_CHARACTER_MIN",3); 			//検索候補文字数最小値
	define("CANDIDACY_ROW_MAX",3);					//検索候補1行の出力制限

	define("GOODSLIST_MAX",100);					//商品リストの出力制限最大値
