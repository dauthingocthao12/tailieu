...
{block name="body"}
		...
		<div class="ranking-details margin-content">
			<div class="title row text-center font-color col-md-9">
					<h2 class="font-color">2021年の占いサイトまとめ</h2>
			</div>
			...
			<div class="row col-md-9">
				...
				<div class="digest-intro digest-font-main">
					<p>2021年全体の占いサイトをまとめました。<br>この中から、あなたにとって良い結果が見つけられますように…。<br>2021年もハッピーな気分で過ごしましょう♪</p>
				</div>
				...
				<p class="conclusion">色々なサイトをまとめましたが、サイトによってさまざまな結果だと思います。<br>中には落ち込んでしまうようなことも書いてあったかもしれませんが、あくまで占いなのでよい結果のほうを信じて、明るい気持ちで見ていただければ幸いです。<br>2021年もハッピーに過ごしましょう♪</p>
				</div>
			</div>
