...
function goods_disp_list($VALUE, $CHECK, $VC) {
	...
	if ($result = pg_query(DB, $sql)) {
		...
		while ($list = pg_fetch_array($result)) {
			...
			if ($VC) {
				$goods_list_html .= "<a href=\"/goods/g".$g_num_."/\">\n";
			} else {
				$goods_list_html .= "<a href=\"./g".$g_num_."/\">\n";
			}

			$imgf_file = "/".IMAGEF."/".$code_.".jpg";
			if (file_exists(".".$imgf_file)) {
				//$goods_list_html .= "<img src=\"".$imgf_file."\" border=\"0\" width=\"100\" height=\"116\" alt=\"".$g_name_."\" /><br />\n";	//	del ookawara 2015/10/09
				$goods_list_html .= "<img src=\"".$imgf_file."\" border=\"0\" width=\"100\" alt=\"".$g_name_."\" /><br />\n";					//	add ookawara 2015/10/09
			}
